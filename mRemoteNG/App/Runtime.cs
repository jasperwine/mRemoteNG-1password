...
namespace mRemoteNG.App
{
    ...
    public static class Runtime
    {
        ...
        private static ICredentialRepositoryList InitializeCredentialCatalog()
        {
            ...
            catalog.AddProvider(new BuiltInCredentialRepository(new BuiltInCredentialRepositoryConfig()));
            catalog.AddProvider(new OnePasswordCredentialRepository(new OnePasswordConfig()));
            return catalog;
        }
